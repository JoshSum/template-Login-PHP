...
-->
          ...
          <div class="col-md-12" style="margin-bottom: -120px;">
            ...
            <div class="VerticalTab VerticalTab_hash_scroll VerticalTab_6 tabs_ver_6">
              ...
              <ul class="resp-tabs-list hor_1">
                ...
                <a href="login.php"><li class="login.php" data-tab-name="login"><span class="tabs-text">Login</span></li></a>
				<a href="register.php"><li class="register.php" data-tab-name="signup"><span class="tabs-text">Signup</span></li></a>
              </ul>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="left-content">
                          ...
                          <h2> Template <em>Login</em> &amp; Register</h2>
                          <p>We process your data very well and easy to use</p>
    ...
    <!-- End HorizontalTab style 6 -->
      ...
      <footer>
        <p>Copyright &copy; 2018 Bank Nusantara Parahyangan 
                                
        | Design: <a href="https://www.instagram.com/josh_sumsum/" target="_parent"><em>Joshua Sumardi</em></a></p>
      </footer>
    </div> <!-- /container -->        
